...
if (!tmp) {
  try {
    ...
    try {
      ...
      console.error(`
  We could not find either window.analytics, Segment's analytics.js package or Segment's @segment/analytics.js-integration package.
